...
//EXI0_INT= EXI0/EXI16,EXI1_INT= EXI1/EXI17, EXI2_INT=EXI2~EXI3/EXI18/EXI19, EXI3_INT=EXI4~EXI9, EXI4_INT=EXI10~EXI15    
	GPIO_IntGroup_Set(PB0,0,Selete_EXI_PIN1);					//PA0.0 set as EXI0  
    ...
    GPIO_EXTI_interrupt(GPIOB0,0b0000000000000010);				//enable GPIOA0.0 as EXI
	
	// GPIO_IntGroup_Set(PB0,0,Selete_EXI_PIN18);					//PB0.0 set as EXI18 
	// GPIO_Init(GPIOB0,0,0);										//PB0.0 set as
...
void I2C_SLAVE_CONFIG(void)
{
	...
	I2C_Slave_CONFIG(I2C_SDA_PA014,I2C_SCL_PA015,STANDARD_MODE,I2C_SLAVE_7BIT,0X57,0X50,0X50);//I2C IO selection,fast mode,slave 7 bit,slave address 0x57(slave address cant set as 0x00~0x07,0x78~0x7f)
...
void UART0_CONFIG(void)
{
    ...
    UARTInit(UART0,208,UART_PAR_NONE);							  //baudrate=sysclock 24m/208=115200
	//UARTInitRxTxIntEn(UART0,208,UART_PAR_NONE);						//baudrate=sysclock 24m/208=115200,tx rx int enabled
	//UART0_Int_Enable();
}	
/*************************************************************/
//UART1  CONFIG
...
void UART2_CONFIG(void)
{
	...
	UARTInit(UART2,208,UART_PAR_NONE);							  //baudrate=sysclock 24m/208=115200
	//UARTInitRxTxIntEn(UART2,208,UART_PAR_NONE);					//baudrate=sysclock 24m/208=115200,tx rx int enabled
	//UART2_Int_Enable();
}	
/*************************************************************/
//adc config
...
void ADC12_CONFIG(void)
{
	...
	ADC12_ConversionChannel_Config(ADC12_ADCIN12,ADC12_CV_RepeatNum1,ADC12_AVGDIS,1);  //SEQ1 chose ADCIN1, 6 Holding cycles , Average 1 time
